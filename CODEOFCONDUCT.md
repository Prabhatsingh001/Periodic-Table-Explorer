# Contributor Covenant Code of Conduct : Periodic-Table-Explorer NSoC'26
...
![Contributors](https://img.shields.io/github/contributors/shwetap3000/Periodic-Table-Explorer?style=for-the-badge) 
...
Whether you are **contributing code, writing documentation, attending discussions, or representing Periodic-Table-Explorer**, you are expected to follow this Code of Conduct.  
...
This Code of Conduct is adapted from the [Contributor Covenant (v3.0)](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), with modifications tailored for **Periodic-Table-Explorer under the Nexus Spring of Code (NSoC’26)**.  
...
We thank every contributor, maintainer, and member for **making Periodic-Table-Explorer a safe, inclusive, and inspiring space.** ✨💡  
...
Let’s make **Periodic-Table-Explorer** a place where everyone feels welcome to **learn, contribute, and innovate.** 🍰🤖💡 
